...
from app.api.v1.endpoints import questions, master_answers, rubrics, submissions, review, analytics, bulk_upload
...
api_router.include_router(bulk_upload.router, prefix="", tags=["bulk-upload"])